...
console.log('DynamoDB client config:', {
  ...
  table: DYNAMO_TABLE,
  hasCredentials: Boolean(dynamoConfig.credentials?.accessKeyId && dynamoConfig.credentials?.secretAccessKey),
});
...
console.log('Analytics table:', DASHBOARD_ANALYTICS_TABLE);
